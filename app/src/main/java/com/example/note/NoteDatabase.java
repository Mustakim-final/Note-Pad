...
public class NoteDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String query="CREATE TABLE "+DATABASE_TABLE+"("+KEY_ID+" INTEGER PRIMARY KEY,"+KEY_TITLE+" TEXT,"+
                KEY_CONTENT+" TEXT,"+KEY_DATE+" TEXT,"+KEY_TIME+" TEXT"+" )";
    ...
    public long addNote(Note note){
        ...
        long ID=sqLiteDatabase.insert(DATABASE_TABLE,null,c);
    ...
    public int editNote(Note note){
        ...
        return sqLiteDatabase.update(DATABASE_TABLE,c,KEY_ID+"=?",new String[]{String.valueOf(note.getId())});
    }
